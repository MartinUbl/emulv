...
TEST_F(Test_GPIO_Port_Input, Is_Set_Input) {
    ASSERT_EQ(GPIO_Port->Get_Pin_Mode(Tested_Pin_No), peripherals::GPIO_Pin_Mode::INPUT);
}

TEST_F(Test_GPIO_Port_Input, Interface_Set_LOW_ISTAT) {
    GPIO_Port->Set_Pin_Level(Tested_Pin_No, peripherals::GPIO_Pin_Level::LOW);
...
TEST_F(Test_GPIO_Port_Input, Interface_Set_HIGH_ISTAT) {
    GPIO_Port->Set_Pin_Level(Tested_Pin_No, peripherals::GPIO_Pin_Level::HIGH);
...
TEST_F(Test_GPIO_Port_Input, Interface_Set_LOW_LOW) {
    GPIO_Port->Set_Pin_Level(Tested_Pin_No, peripherals::GPIO_Pin_Level::LOW);
    ASSERT_EQ(GPIO_Port->Get_Pin_Level(Tested_Pin_No), peripherals::GPIO_Pin_Level::LOW);
    GPIO_Port->Set_Pin_Level(Tested_Pin_No, peripherals::GPIO_Pin_Level::LOW);
    ASSERT_EQ(GPIO_Port->Get_Pin_Level(Tested_Pin_No), peripherals::GPIO_Pin_Level::LOW);
}
...
TEST_F(Test_GPIO_Port_Input, Interface_Set_LOW_HIGH) {
    ...
    ASSERT_EQ(GPIO_Port->Get_Pin_Level(Tested_Pin_No), peripherals::GPIO_Pin_Level::LOW);
    GPIO_Port->Set_Pin_Level(Tested_Pin_No, peripherals::GPIO_Pin_Level::HIGH);
    ASSERT_EQ(GPIO_Port->Get_Pin_Level(Tested_Pin_No), peripherals::GPIO_Pin_Level::HIGH);
}
