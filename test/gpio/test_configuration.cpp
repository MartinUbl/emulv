...
class Test_GPIO_Port_Configuration : public Test_GPIO_Port {
    protected:
        ...
        void SetUp() override {
            GPIO_Port = new peripherals::GPIO_Port {"GPIO", kStart_Address, kEnd_Address};
        }
...
TEST_F(Test_GPIO_Port_Configuration, Configure_Pin_Out_0) {
    ...
    ASSERT_EQ(GPIO_Port->Get_Pin_Mode(0), peripherals::GPIO_Pin_Mode::OUTPUT);
}
...
TEST_F(Test_GPIO_Port_Configuration, Configure_Pin_Out_7) {
    ...
    ASSERT_EQ(GPIO_Port->Get_Pin_Mode(7), peripherals::GPIO_Pin_Mode::OUTPUT);
}
...
TEST_F(Test_GPIO_Port_Configuration, Configure_Pin_Out_8) {
    ...
    ASSERT_EQ(GPIO_Port->Get_Pin_Mode(8), peripherals::GPIO_Pin_Mode::OUTPUT);
}
...
TEST_F(Test_GPIO_Port_Configuration, Configure_Pin_Out_15) {
    ...
    ASSERT_EQ(GPIO_Port->Get_Pin_Mode(15), peripherals::GPIO_Pin_Mode::OUTPUT);
}
...
TEST_F(Test_GPIO_Port_Configuration, Configure_Pin_In_0) {
    ...
    ASSERT_EQ(GPIO_Port->Get_Pin_Mode(0), peripherals::GPIO_Pin_Mode::INPUT);
}
...
TEST_F(Test_GPIO_Port_Configuration, Configure_Pin_In_7) {
    ...
    ASSERT_EQ(GPIO_Port->Get_Pin_Mode(7), peripherals::GPIO_Pin_Mode::INPUT);
}
...
TEST_F(Test_GPIO_Port_Configuration, Configure_Pin_In_8) {
    ...
    ASSERT_EQ(GPIO_Port->Get_Pin_Mode(8), peripherals::GPIO_Pin_Mode::INPUT);
}
...
TEST_F(Test_GPIO_Port_Configuration, Configure_Pin_In_15) {
    ...
    ASSERT_EQ(GPIO_Port->Get_Pin_Mode(15), peripherals::GPIO_Pin_Mode::INPUT);
}
